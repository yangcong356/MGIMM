...
from utils.constants import DEFAULT_IMAGE_TOKEN,DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, IGNORE_INDEX, IMAGE_TOKEN_INDEX
...
def apply_boxes(boxes: np.ndarray, original_size: Tuple[int, ...], target_length: int) -> np.ndarray:
    """
